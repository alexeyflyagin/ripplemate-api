...
async def test_cannot_create_category_in_other_users_workspace(client, workspace_id):
    await client.post(
        "/auth/register",
...
async def test_cannot_rename_category_in_other_users_workspace(client, workspace_id, category_id):
    await client.post(
        "/auth/register",
...
async def test_cannot_delete_category_in_other_users_workspace(client, workspace_id, category_id):
    await client.post(
        "/auth/register",
